...
## CH05 complete clear-line-watercolor execution and three-route comparison — 2026-09-02

Executed all 11 gated OpenAI built-in ImageGen sequence requests and bound 11 exact source hashes covering P001–P050 once. Deterministic crop extraction produced 50 ordered ComicPanelPlan candidates; chapter assembly produced clean and lettered 1200×24361 scrolls, 390×7917 phone editions, safe-zone overlays, a continuity sheet, and a triage sheet. Timing is 1,090.0 seconds across six overlap-adjusted tool-call batches; only S01 has an individual duration. Model, endpoint, provider request ID, usage, monetary cost, and seed remain unavailable. Direct paid API/cloud spend is $0.

Non-gating triage is 45 PASS / 2 WARN / 3 FAIL with hair and wardrobe stable in 50/50 panels. The arm solves P029, P036, and P041 relative to alternate graphic. P001 still reverses departure direction, P039 does not frame all three map marks simultaneously, and P043 leaves the map by the tin despite P046 possession. P003 and P032 remain subtle at phone width. R6 remains the semantic base; clear-line watercolor is the leading style-development arm only. A deterministic three-route comparison and owner start-here record preserve all three complete reading drafts without inferring acceptance, commercial clearance, or exact-production-base status.

## CH05 premium-cel full chapter, targeted repairs, and semantic-pass hybrid — 2026-09-02

Executed 11 premium-cel sequence requests covering all 50 ComicPanelPlans. Exact RenderRecords bind 23 authorized reference uses and 1,234.0 seconds across six timing batches. Fifty deterministic crops required zero manual gutter overrides. Clean and lettered chapters are 1200×24247; phone editions are 390×7880. Premium triage is 40 PASS / 5 WARN / 5 FAIL with correct Soren/Sigrid hair and wardrobe on 50/50 panels. Failures are P001 departure, P013 role order, P029 exterior-watch independence, P036 visible tin/contact, and P039 simultaneous mark count.

The four-route comparison ranks r6 semantic base, clear-line style lead, premium-cel selected-panel source, and alternate-graphic control. Premium equal-panel metrics are edge density 0.227841, grayscale entropy 6.934245 bits, and PNG bytes/native pixel 1.656707: only partial separation from the other detailed arms.

The preflighted targeted P001/P032/P039 tranche ran as one 169.0-second parallel batch with six reference uses. P001 and P039 pass; P032 remains WARN for exact heel/toe direction at 390px. A review-only hybrid selects 28 r6 + 9 clear-line + 11 premium + 2 targeted panels, reaches 49 PASS / 1 WARN / 0 FAIL, and produces a 1200×25651 lettered scroll plus 390×8337 phone edition. Its 33 adjacent route transitions make it semantic integration evidence, not a uniform-finish production recommendation.

## CH05 flat-gouache and reduced-palette complete controls — 2026-09-03

The flat graphic-gouache arm completed 11 built-in outputs and 50 deterministic crops using 23 authorized reference uses. Its non-overlap observed arithmetic is 1,290.989 seconds from nine individual walls plus one S10/S11 concurrent-pair wall; actual end-to-end wall time is unavailable. Triage is 16 PASS / 7 WARN / 27 FAIL overall and 41/6/3 semantic, with 19/6/25 lettering and 0/0/50 style. The result is diagnostic complete-chapter evidence, not a production selection.

The stricter reduced-palette text-only arm completed 11 sequence outputs and 50 deterministic crops with zero references and zero uploads. Its measured timing is 568.300 seconds of known individual walls plus 459.352 seconds of concurrent-batch walls, or 1,027.652 seconds of explicitly non-overlap observed arithmetic; no actual end-to-end stopwatch exists. Direct paid API/cloud activity and spend are 0/`$0`; built-in monetary cost and service metadata remain unavailable.

Reduced-palette triage is 6 PASS / 6 WARN / 38 FAIL overall, 43/4/3 semantic, 17/6/27 lettering, 43/7/0 phone, and 12/7/31 style. The 32 panels with visible adult cast preserve identity, hair, and wardrobe on 32/32; 18 plans show no visible cast. The six all-axis shortlist candidates are P010, P014, P035, P040, P041, and P046. P008, P036, and P050 remain targeted-correction candidates, and the broad lettering-zone failures block wholesale promotion.

## CH05 six-route cadence and reference ablations — 2026-09-03

The six-route comparison covers 300 panel candidates across six complete 50-plan reading drafts. Equal-panel complexity proxies for r6 / alternate / clear-line / premium / flat / reduced are entropy 6.889241 / 6.837860 / 7.025710 / 6.934245 / 6.897733 / 6.572611 bits; edge density 0.220004 / 0.215718 / 0.244026 / 0.227841 / 0.211280 / 0.149995; and PNG bytes/native pixel 1.623124 / 1.608028 / 1.698281 / 1.656707 / 1.581633 / 1.397747. These are visual-complexity proxies, not quality or rights measurements.
