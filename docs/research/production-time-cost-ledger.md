...
As of 2026-09-01, completed local experiments total **79 renderer generations** and **2,568.448 seconds (0.713 hours)** of measured renderer time. The controlled external bakeoff has **8 completed candidates** plus **1 paid candidate-download failure**, with **174.525 seconds** of measured provider/attempt time and **$0.537377** committed. OpenAI/Gemini costs are documented-rate estimates; xAI reported its exact cost ticks. Local electricity/depreciation, invoice-level confirmation for estimated arms, and timed human-review minutes remain unmeasured.
...
Before external execution, ADR-0023 validation measured exactly one successful and one denied competing $6 reservation against a $10 test cap; after a $1.25 reconciliation and a proven-unsubmitted release, available test capacity was $8.75. This used temporary test ledgers and no provider call. After OpenAI 4/4, Gemini 4/4, and one paid xAI failure, the real ledger is committed $0.537377, held $0, available $99.462623. Officially documented ceilings allow at most $4.20 held for the complete 16-request bakeoff.
