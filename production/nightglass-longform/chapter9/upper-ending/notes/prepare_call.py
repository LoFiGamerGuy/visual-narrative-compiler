...
r=b/'production/nightglass-longform/chapter9/upper-ending'
...
assert g['chapter_additional_ceiling']==72 and g['scope_ceilings']['upper-ending']==6, 'Gate must match the approved Chapter9 scope allocation'
...
assert unit in ['N9-39-40', 'N9-41-42'], 'Exact frozen original unit required; no renaming or scope reset'
...
assert sum(bool(c.get('invoked')) for c in records)<g['scope_ceilings']['upper-ending'],'Local finite allowance exhausted'
