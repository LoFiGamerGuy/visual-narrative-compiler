...
def gate(root,milestone):
    ...
    required={'trial':[], 'chapter1':[1], 'threechapters':[1,2,3], 'fourchapters':[1,2,3,4], 'fivechapters':[1,2,3,4,5], 'sixchapters':[1,2,3,4,5,6], 'sevenchapters':[1,2,3,4,5,6,7]}[milestone]
...
def main():
    ...
    parser.add_argument('--version');parser.add_argument('--milestone',choices=['trial','chapter1','threechapters','fourchapters','fivechapters','sixchapters','sevenchapters'],default='trial')
