...
if not intervals:
 (ROOT/'mesh-alpha-verification-failed.json').write_text(json.dumps(report,indent=2)+'\n')
 raise RuntimeError('No partition bounds met threshold; preserved partial inspection data.')
