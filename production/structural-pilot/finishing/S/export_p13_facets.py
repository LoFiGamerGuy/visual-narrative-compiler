...
ROOT=Path(__file__).resolve().parents[4];OUT=ROOT/'production/structural-pilot/finishing/S/P13/F01-v3'
bpy.context.window.scene=bpy.data.scenes['P13'];scene=bpy.context.scene;bpy.context.view_layer.update()
...
(OUT/'kite-facets.json').write_text(json.dumps({'source_blend':'production/structural-pilot/control/v8/scene-all.blend','panel':'P13','faces':faces,'svg':svg},indent=2)+'\n')
