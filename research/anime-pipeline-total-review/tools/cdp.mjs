...
const scratch=resolve(root,'research/anime-pipeline-total-review/.scratch/browser-comparables');
...
if(op==='start'){
  ...
  const browser=spawn('/home/gosnerp/.cache/ms-playwright/chromium-1234/chrome-linux64/chrome',[
    ...
    {detached:true,stdio:['ignore',log,log],env:{...process.env,LD_LIBRARY_PATH:resolve(scratch,'lib/usr/lib/x86_64-linux-gnu')}});
  browser.unref();
