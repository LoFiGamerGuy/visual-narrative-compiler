...
manifest=json.loads((HERE/'v2-guides/manifest.json').read_text());rows=[]
...
with (HERE/'v2-guides/render-receipt-native.json').open('x') as f:json.dump(receipt,f,indent=2);f.write('\n')
