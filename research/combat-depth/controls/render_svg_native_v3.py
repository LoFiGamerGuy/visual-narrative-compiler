...
manifest=json.loads((HERE/'v3-contact/manifest.json').read_text());rows=[]
...
with (HERE/'v3-contact/render-receipt-native.json').open('x') as f:json.dump(receipt,f,indent=2);f.write('\n')
