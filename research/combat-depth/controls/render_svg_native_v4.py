...
manifest=json.loads((HERE/'v4-sword-continuity/manifest.json').read_text());rows=[]
...
with (HERE/'v4-sword-continuity/render-receipt-native.json').open('x') as f:json.dump(receipt,f,indent=2);f.write('\n')
