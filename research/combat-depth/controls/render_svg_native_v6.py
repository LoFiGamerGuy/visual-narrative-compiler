...
manifest=json.loads((HERE/'v6-sword-clearance/manifest.json').read_text());rows=[]
...
with (HERE/'v6-sword-clearance/render-receipt-native.json').open('x') as f:json.dump(receipt,f,indent=2);f.write('\n')
