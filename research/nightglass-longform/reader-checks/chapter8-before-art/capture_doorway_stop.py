...
R=Path('/mnt/c/AgentWorkspaces/anime-pipeline-nightglass-longform-20260909-2110');O=R/'research/nightglass-longform/reader-checks/chapter8-doorway-stop-reviewed';O.mkdir(exist_ok=True)
...
with sync_playwright() as p:
 ...
 for name,first,last in [('doorway-stop-17-19','N8-17','N8-19')]:
