...
R=Path('/mnt/c/AgentWorkspaces/anime-pipeline-nightglass-longform-20260909-2110');O=R/'research/nightglass-longform/reader-checks/chapter8-existing-hatch-reviewed';O.mkdir(exist_ok=True)
...
with sync_playwright() as p:
 ...
 for name,first,last in [('existing-hatch-19-22','N8-19','N8-22')]:
