...
R=Path('/mnt/c/AgentWorkspaces/anime-pipeline-nightglass-longform-20260909-2110');O=R/'research/nightglass-longform/reader-checks/chapter8-meeting-room-reviewed';O.mkdir(exist_ok=True)
...
with sync_playwright() as p:
 ...
 for name,first,last in [('opening-01-02','N8-01','N8-02'),('ending-44-45','N8-44','N8-45')]:
