...
R=Path('/mnt/c/AgentWorkspaces/anime-pipeline-nightglass-longform-20260909-2110');O=R/'research/nightglass-longform/reader-checks/chapter8-supported-contact-reviewed';O.mkdir(exist_ok=True)
...
with sync_playwright() as p:
 ...
 for name,first,last in [('supported-contact-14-16','N8-14','N8-16')]:
