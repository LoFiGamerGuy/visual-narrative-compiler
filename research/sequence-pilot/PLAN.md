# Implementation and alternatives research

Active goal: implement a bounded, original storyboard-led pilot and research credible routes toward premium action-webtoon craft. Prior audit is complete; its findings are inputs, not fresh independent measurements.

1. [complete] Freeze scope, original 14-panel specification and research questions; start preservation snapshot; create isolated implementation branch from delivered audit 9a911fd.
...
File ownership: root owns production/sequence-pilot, research/sequence-pilot and docs/research/sequence-pilot; rendering_research owns src/sequence_pilot excluding web and tests/sequence_pilot; authoring_research owns src/sequence_pilot/web. Research assignments were completed before these separate coding assignments.
