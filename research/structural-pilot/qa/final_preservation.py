...
import gzip,json,os,subprocess,datetime,argparse
...
out=Path(args.output).resolve() if args.output else HERE/'evidence/final-protected-status.json'
if not out.is_relative_to(HERE):raise ValueError('Output must stay in this task research directory')
