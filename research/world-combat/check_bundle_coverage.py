...
H=R/'research/world-combat/asset-bundle'
...
rows=json.loads((R/'production/world-combat/candidates.json').read_text())['candidates']
...
mapping={'research/world-combat/asset-bundle/START_HERE.cmd':'START_HERE.cmd'}
missing=[p for p in paths if mapping.get(p,p) not in sources]
out={'schema':'WorldCombatBundleCoverage/1','pass':not missing,
