...
P=ROOT/'production/world-components'
...
(P/'candidates.json').write_text(json.dumps({'schema':'WorldComponentCandidates/1','experiment_id':'WC-20260907-01','candidates':rows},indent=2)+'\n')
selection_path=P/'selected.json'
selected=json.loads(selection_path.read_text()) if selection_path.exists() else {'schema':'WorldComponentSelection/1','experiment_id':'WC-20260907-01','selected':{},'owner_approval':None}
for c in rows:
