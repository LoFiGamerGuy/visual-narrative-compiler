"""Build deterministic six-chapter visual-progression review artifacts."""
...
OUT_DIR = ROOT / "experiments/review-packets/ch06-ch11-progression-review-r1"
MANIFEST = ROOT / "production/comic/run-manifests/ch06-ch11-progression-review-r1.json"
...
def main() -> int:
    ...
    contact_out = OUT_DIR / "ch06-ch11-progression-contact-sheet-r1.png"
    sequence_out = OUT_DIR / "ch06-ch11-sequence-progression-r1.png"
    sampler_out = OUT_DIR / "ch06-ch11-phone-progression-sampler-r1.png"
    ...
    artifacts = []
    for kind, path in (
        ("six_chapter_contact_sheet", contact_out),
        ("six_chapter_sequence_progression", sequence_out),
        ("six_chapter_phone_sampler", sampler_out),
    ):
    ...
    manifest = {
        ...
        "schema_version": "1.0",
        "record_id": "ng-ch06-ch11-progression-review-r1",
        ...
        "limitations": [
            ...
            "All ten documented blocking candidates remain visible and attributable to their source chapters.",
    ...
    print(json.dumps({"artifacts": 3, "chapters": 6, "panels": 240, "sampled": 54, "triage": triage_total}, sort_keys=True))
    return 0
