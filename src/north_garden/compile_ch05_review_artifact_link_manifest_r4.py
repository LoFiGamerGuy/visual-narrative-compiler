"""Extend exact CH05 review links with current delivery and capacity handoff."""
from __future__ import annotations
import hashlib,json,subprocess
from collections import defaultdict
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; BASE=ROOT/"production/comic/review/ch05-review-artifact-link-manifest-r3.json"; OUTPUT=ROOT/"production/comic/review/ch05-review-artifact-link-manifest-r4.json"; MARKDOWN=ROOT/"docs/research/ch05-review-links-r4.md"; EVIDENCE=ROOT/"docs/research/evidence/ch05-review-artifact-link-manifest-r4.json"
ADDED=[("experiments/review-packets/ch05-owner-review-index-r6/index.html",["review_hubs"]),("experiments/review-packets/ch05-chapter-production-duration-capacity-r1/ch05-chapter-duration-capacity-map-r1.png",["diagnostic_and_policy_sheets"]),("docs/research/ch05-chapter-production-operating-playbook-r1.md",["review_checklists"]),("docs/research/ch05-overnight-delivery-summary-r2.md",["review_checklists"]),("production/comic/handoff/ch05-overnight-delivery-bundle-r2.json",["packet_records"])]
