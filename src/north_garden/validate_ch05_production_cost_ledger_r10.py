"""Validate append-only CH05 zero-external-cost ledger r10."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R9=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r9.json"; R10=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r10.json"
NAMES=["hardening_release_validation_orchestrator_r2"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R10.read_text(encoding="utf-8"))==e,"tracked r10 differs")
