"""Validate append-only CH05 zero-external-cost ledger r11."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R10=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r10.json"; R11=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r11.json"
NAMES=["selected_route_hardening_state_manifest_r2"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R11.read_text(encoding="utf-8"))==e,"tracked r11 differs")
