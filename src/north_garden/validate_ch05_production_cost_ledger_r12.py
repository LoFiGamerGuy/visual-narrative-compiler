"""Validate append-only CH05 zero-external-cost ledger r12."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R11=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r11.json"; R12=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r12.json"
NAMES=["p036_prerequisite_authority_lattice_r1"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R12.read_text(encoding="utf-8"))==e,"tracked r12 differs")
