"""Validate append-only CH05 zero-external-cost ledger r13."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R12=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r12.json"; R13=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r13.json"
NAMES=["hardening_release_validation_orchestrator_r3"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R13.read_text(encoding="utf-8"))==e,"tracked r13 differs")
