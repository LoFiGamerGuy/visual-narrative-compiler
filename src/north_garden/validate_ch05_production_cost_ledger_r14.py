"""Validate append-only CH05 zero-external-cost ledger r14."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R13=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r13.json"; R14=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r14.json"
NAMES=["safe_source_release_manifest_r3"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R14.read_text(encoding="utf-8"))==e,"tracked r14 differs")
