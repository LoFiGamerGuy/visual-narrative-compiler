"""Validate append-only CH05 zero-external-cost ledger r15."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R14=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r14.json"; R15=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r15.json"
NAMES=["current_evidence_lineage_index_r1"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R15.read_text(encoding="utf-8"))==e,"tracked r15 differs")
