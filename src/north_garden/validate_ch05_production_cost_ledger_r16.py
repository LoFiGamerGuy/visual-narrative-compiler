"""Validate append-only CH05 zero-external-cost ledger r16."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R15=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r15.json"; R16=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r16.json"
NAMES=["current_evidence_reproducer_matrix_r1"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R16.read_text(encoding="utf-8"))==e,"tracked r16 differs")
