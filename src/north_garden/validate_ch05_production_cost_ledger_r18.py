"""Validate append-only CH05 zero-external-cost ledger r18."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R17=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r17.json"; R18=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r18.json"
NAMES=["review_authority_handoff_packet_r1"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R18.read_text(encoding="utf-8"))==e,"tracked r18 differs")
