"""Validate append-only CH05 zero-external-cost ledger r19."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R18=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r18.json"; R19=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r19.json"
NAMES=["current_evidence_reproducer_matrix_r2","hardening_release_validation_orchestrator_r4"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R19.read_text(encoding="utf-8"))==e,"tracked r19 differs")
