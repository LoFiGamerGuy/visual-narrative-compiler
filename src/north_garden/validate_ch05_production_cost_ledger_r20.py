"""Validate append-only CH05 zero-external-cost ledger r20."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R19=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r19.json"; R20=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r20.json"
NAMES=["provider_documentation_pre_spend_chronology_r1"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R20.read_text(encoding="utf-8"))==e,"tracked r20 differs")
