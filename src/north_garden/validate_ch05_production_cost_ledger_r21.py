"""Validate append-only CH05 zero-external-cost ledger r21."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R20=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r20.json"; R21=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r21.json"
NAMES=["autonomous_research_engineering_closeout_r1"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R21.read_text(encoding="utf-8"))==e,"tracked r21 differs")
