"""Validate append-only CH05 zero-external-cost ledger r22."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R21=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r21.json"; R22=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r22.json"
NAMES=["hardening_release_validation_orchestrator_r5"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R22.read_text(encoding="utf-8"))==e,"tracked r22 differs")
