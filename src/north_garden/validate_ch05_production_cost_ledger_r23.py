"""Validate append-only CH05 zero-external-cost ledger r23."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R22=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r22.json"; R23=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r23.json"
NAMES=["final_safe_source_git_parity_r1"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R23.read_text(encoding="utf-8"))==e,"tracked r23 differs")
