"""Validate append-only CH05 zero-external-cost ledger r5."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R4=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r4.json"; R5=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r5.json"
NAMES=["selected_route_hardening_state_manifest_r1","disconnected_and_holed_mask_topology_stress_r1","scale_aware_boundary_selector_contract_r2","selected_route_artifact_rebuild_reproducibility_r2"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R5.read_text(encoding="utf-8"))==e,"tracked r5 differs")
