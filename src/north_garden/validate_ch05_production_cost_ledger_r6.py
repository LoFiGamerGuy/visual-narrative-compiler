"""Validate append-only CH05 zero-external-cost ledger r6."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R5=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r5.json"; R6=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r6.json"
NAMES=["bakeoff_adapter_aggregate_budget_binding_audit_r3","hardening_release_validation_orchestrator_r1"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R6.read_text(encoding="utf-8"))==e,"tracked r6 differs")
