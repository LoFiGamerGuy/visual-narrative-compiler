"""Validate append-only CH05 zero-external-cost ledger r7."""
from __future__ import annotations
import argparse,copy,hashlib,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; R6=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r6.json"; R7=ROOT/"docs/research/evidence/ch05-production-cost-ledger-r7.json"
NAMES=["selector_consumer_compatibility_r2"]
...
def main():
 ...
 try:
  ...
  else:req(json.loads(R7.read_text(encoding="utf-8"))==e,"tracked r7 differs")
