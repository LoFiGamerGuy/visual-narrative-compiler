...
def execute_one(plan: dict, item: dict, api_key: str) -> Path:
    ...
    payload = {"model": MODEL, "prompt": prompt, "image": {"type": "image_url", "url": image_data_uri}, "aspect_ratio": "3:2", "resolution": "1k", "quality": "medium", "response_format": "url"}
    ...
    reservation = reserve_bakeoff_request("grok_imagine_image_2", item["id"])
    started_at = stamp()
    ...
    record = {
        ...
        "request_id": None, "request_body_redacted": {"model": MODEL, "request_id": item["id"], "prompt_sha256": hashlib.sha256(prompt.encode()).hexdigest(), "aspect_ratio": "3:2", "resolution": "1k", "quality": "medium", "source_asset": asset_key},
